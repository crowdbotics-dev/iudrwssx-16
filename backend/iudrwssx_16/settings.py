"""
Django settings for iudrwssx_16 project.
...
WSGI_APPLICATION = 'iudrwssx_16.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "iudrwssx_16 API",
    "DESCRIPTION": "API documentation for iudrwssx_16 App",
    "VERSION": "v1",
}
